      ...
      <Section id="about" background="white">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-[#2F4F2F]/80 leading-relaxed">....</p>
          </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-lg text-[#2F4F2F]/80 mb-8 leading-relaxed">
              We&apos;d love to hear from you. Whether you want to support our
              cause, volunteer, or simply learn more about our work, reach out
              today.
            </p>
