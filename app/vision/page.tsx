        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
          ...
          >
            ...
            <p className="text-base md:text-lg text-[#2F4F2F]/80 max-w-3xl mx-auto leading-relaxed">
              ...
              economically empowered society through cow-based natural food
              systems and rural development — where traditional wisdom meets
              modern innovation.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  'Making natural, A2 milk-based nutrition accessible to all — especially vulnerable communities — through sustainable dairy systems.',
                color: 'bg-[#4D7C0F]',
                delay: 0,
              },
              {
                ...
                description:
                  'Creating sustainable livelihoods for rural farmers through fair trade, skill development, and value-added cow-based products.',
                color: 'bg-[#D97706]',
                delay: 0.1,
              },
              {
                ...
                description:
                  'Promoting chemical-free natural farming using cow-based composting, regenerative agriculture, and waste-to-wealth solutions.',
                color: 'bg-[#7A5C33]',
                delay: 0.2,
              },
            ].map((item, index) => (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <div className="text-sm md:text-base text-[#2F4F2F]/70 font-medium">
                  {stat.label}
                </div>
              </motion.div>
            ))}
